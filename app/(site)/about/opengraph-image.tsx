...
// description (config/site.ts's PageMetadata.about). Fully static: no
// params, no fetch, so it is prerendered once and cached like any other
// static asset.
export const alt = PageMetadata.about.description;
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {SiteMetadata.siteUrl.replace("https://", "")}/about
        </div>
      </div>
    ),
    { ...size }
