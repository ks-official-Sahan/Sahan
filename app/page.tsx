"use client";
import IMAGINECOREX_ICON from "@/components/icons/ImaginecoreX";
              ...
              <div className="flex items-end gap-[62px]">
                ...
                >
                  ...
                  <a
                    ...
                    className="w-full"
                  >
                    <Button className="mt-[20px] justify-start h-[40px] w-full border rounded-full p-[4px] flex items-center gap-[10px] bg-[#ffffff75] dark:bg-[#00000075] backdrop-blur-sm">
                      ...
                      <span
                        className={`${righteous.className} text-[14px] bg-imcroxBro bg-clip-text text-transparent`}
                      >
                        www.imaginecorex.com
                      </span>
                    </Button>
                  </a>
                </motion.div>
