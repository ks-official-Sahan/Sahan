      ...
      <section className="w-full h-[380px] border-b box-border pt-[151px] text-center dark:bg-grid-small-white/[0.1] bg-grid-small-black/[0.2] relative">
        ...
        <WrapperBody>
          <div className="flex flex-col items-center">
            ...
            />
            <div className="max-w-[558px] pt-3 text-secondaryT">
        ...
        <WrapperBody>
          <div className="flex gap-[20px]">
            <RecentPost
              ...
              description="A deep dive into how I developed a centralized identity management system for Evision IT, featuring best practices and challenges faced."
